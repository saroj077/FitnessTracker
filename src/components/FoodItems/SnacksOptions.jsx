...
const SnacksOptions = () => {
  ...
  const [selectedFoods, setSelectedFoods] = useState(() => {
    const storedFoods = localStorage.getItem('selectedSnacksFoods');
  ...
  useEffect(() => {
    ...
    localStorage.setItem('selectedSnacksFoods', JSON.stringify(selectedFoods));
  }, [selectedFoods]);
  ...
  return (
    <div className='breakfast-options'>
      <h2 className='section-title'>Snacks Options</h2>
