...
const LunchOptions = () => {
  ...
  const [selectedFoods, setSelectedFoods] = useState(() => {
    const storedFoods = localStorage.getItem('selectedLunchFoods');
  ...
  useEffect(() => {
    ...
    localStorage.setItem('selectedLunchFoods', JSON.stringify(selectedFoods));
  }, [selectedFoods]);
  ...
  return (
    <div className='breakfast-options'>
      <h2 className='section-title'>Lunch Options</h2>
